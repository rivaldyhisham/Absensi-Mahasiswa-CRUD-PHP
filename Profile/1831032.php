  ...
  <head>
    ...
    <style>
      ...
      .kartu {
        ...
        margin:  auto;
        margin-top: 100px;
            box-shadow: 0 0.25rem 1.75rem rgba(0,0,0,.03);
    transition: all .3s;
...
<div class="container">
  <div class="card kartu">
    <div class="row">
      <div class="col-md-4">
      <div class="foto">
        <img src="/img/mhs1.jpg" class="img-thumbnail" alt="" width="150" height="auto">
      </div>
      </div>
          ...
          <tbody>
            <tr>
              <td width="25%" valign="top" class="textt">Nama</td>
                <td width="2%">:</td>
                <td style="color: #e9a7f9; font-weight:bold">Muhammad Rivaldy Hisham</td>
            </tr>
          <tr>
